...
{   
    ...
    Setting[e_NGate] = parameters.getRawParameterValue("ngate");
    Setting[e_Drive] = parameters.getRawParameterValue("drive");
    Setting[e_Boom] = parameters.getRawParameterValue("boom");
    Setting[e_EQ] = parameters.getRawParameterValue("eq");
    Setting[e_EQ1] = parameters.getRawParameterValue("eq1");
    Setting[e_EQ2] = parameters.getRawParameterValue("eq2");
    Setting[e_EQ3] = parameters.getRawParameterValue("eq3");
    Setting[e_EQ4] = parameters.getRawParameterValue("eq4");
    Setting[e_EQ5] = parameters.getRawParameterValue("eq5");
    Setting[e_Amp] = parameters.getRawParameterValue("amp");
    Setting[e_IR] = parameters.getRawParameterValue("ir");
    Setting[e_Mono] = parameters.getRawParameterValue("mono");
    Setting[e_Pedal] = parameters.getRawParameterValue("pedal");
    Setting[e_Thump] = parameters.getRawParameterValue("thump");
    Setting[e_Air] = parameters.getRawParameterValue("air");
    Setting[e_Power] = parameters.getRawParameterValue("power");
